...
public class MySharedPreferences {
    ...
    public static MySharedPreferences getInstance(Context context, String prefName) {
        if (instance == null) {
            instance = new MySharedPreferences(context, prefName,
                    prefName + "Key", true);
        }
        return instance;
    }
    ...
    protected String decrypt(String securedEncodedValue) {
        byte[] securedValue = Base64
                .decode(securedEncodedValue, Base64.DEFAULT);
